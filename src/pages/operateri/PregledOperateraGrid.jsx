...
import { FaEdit, FaKey, FaTimes, FaTrash } from "react-icons/fa";
import { FaAt, FaMagnifyingGlass, FaUserGear } from "react-icons/fa6";

export function PregledOperateraGrid({ operateri, navigate, obrisi }) {
            ...
            {operateri.map((operater) => (
                ...
                >
                    ...
                    <Row className={"text-start text-break"}>
                        <Col xs={12}>
                            <FaUserGear color={"lightblue"} className={"mb-1"} />&nbsp;<b>Uloga</b>:&nbsp;<span style={{ color: operater.uloga === "admin" ? "#E07C7C" : "#6FAFF0" }}>{operater.uloga}</span>
                        </Col>
